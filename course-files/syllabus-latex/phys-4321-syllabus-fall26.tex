...
Generative AI tools, such as ChatGPT, Claude, Gemini, and Copilot, are permitted in this course under a policy adapted from the American Physical Society (APS) journals. You are fully responsible for everything in your report, and you must check all AI output you use. Light editing (spelling, grammar, trimming wording) needs no disclosure. Any substantive use, such as analysis code, calculations, figures, literature search, or feedback on drafts, must be disclosed inside the report in an \textbf{AI Disclosure Statement}. AI may not generate or alter data, write your report, or supply sources you have not read. See the \href{https://ajsteinmetz.github.io/gt-phys-4321/course-files/ai-disclosure-statement.html}{AI Disclosure Statement} page on the course website for what to disclose, where, and examples.
